...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; Hódmezővásárhely MJV Polgármesteri Hivatala <?= date('Y') ?></div>
            <div class="col-md-6 text-center text-md-end">By: Barcza <u>Dávid</u> Szilveszter</div>
        </div>
    </div>
</footer>
